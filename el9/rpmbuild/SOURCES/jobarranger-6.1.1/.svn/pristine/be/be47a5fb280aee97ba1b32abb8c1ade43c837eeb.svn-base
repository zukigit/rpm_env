...
Sidebar.prototype.addGeneralPalette = function(expand)
{
    ...
    var fns = [
        this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;fontSize=11;', 76, 30, 'JOB', null, null, null, '',true, jaConstants.ICON_TYPE_JOB),
        this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;fontSize=11;', 76, 30, 'IF', null, null, null, 'diamond rhombus if condition decision conditional question test',true, jaConstants.ICON_TYPE_CONDITIONAL_START),
        this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;fontSize=11;', 35, 35, '|', null, null, null, 'diamond rhombus if condition decision conditional question test',true, jaConstants.ICON_TYPE_CONDITIONAL_END),
        this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;rotation=90;fontSize=20;', 35, 35, 'E', null, null, null, '',true, jaConstants.ICON_TYPE_PARALLEL_START),
        this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;rotation=270;fontSize=20;', 35, 35, 'E', null, null, null, '',true, jaConstants.ICON_TYPE_PARALLEL_END),
        this.createVertexTemplateEntry('shape=parallelogram;html=1;fontSize=11;', 76, 30, 'VARIABLE', null,null,null,'',true, jaConstants.ICON_TYPE_JOB_CONTROL_VARIABLE),
        this.createVertexTemplateEntry('shape=process;whiteSpace=wrap;html=1;backgroundOutline=1;fontSize=11;', 76, 30, 'EXTENSION', null, null, null, 'process task',true, jaConstants.ICON_TYPE_EXTENDED_JOB),
        this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;fontSize=11;arcSize=50;', 76, 30, 'START', null, null, null, '',true, jaConstants.ICON_TYPE_START),
        this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;fontSize=11;arcSize=50;', 76, 30, 'END', null, null, null, '',true, jaConstants.ICON_TYPE_END),
        this.createVertexTemplateEntry('shape=trapezoid;html=1;fontSize=11;', 76, 30, 'CALC', null,null,null,'',true, jaConstants.ICON_TYPE_CALCULATION),
        this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;fontSize=20;', 35, 35, 'L', null, null, null, '',true, jaConstants.ICON_TYPE_LOOP),
        this.createVertexTemplateEntry('shape=hexagon;whiteSpace=wrap;html=1;fontSize=11;', 76, 30, 'TASK', null, null, null, '',true, jaConstants.ICON_TYPE_TASK),
        this.createVertexTemplateEntry('shape=card;whiteSpace=wrap;html=1;fontSize=11;', 76, 30, 'INFO', null,null,null,'',true, jaConstants.ICON_TYPE_INFO),
        this.addEntry('general subprocess sub process sub-process', function()
                {
                    var cell = new mxCell('F-TRANSFER', new mxGeometry(0, 0, 76, 30), 'shape=document;whiteSpace=wrap;html=1;boundedLbl=1;dropTarget=0;fontSize=11;',jaConstants.ICON_TYPE_FILE_COPY,'F-TRANSFER',null, null);
                    cell.vertex = true;

                    var cell1 = new mxCell('&#8680;', new mxGeometry(0.9, 0.95, 14, 14), 'boundary=none;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_FILE_COPY,jaConstants.CHILD_ICON,null, null);
                    cell1.vertex = true;
                    cell1.geometry.relative = true;
                    cell1.geometry.offset = new mxPoint(-7, -14);
                    cell.insert(cell1);
                    return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'F-TRANSFER',null,null,null,true);
                }),
        this.addEntry('general subprocess sub process sub-process', function()
                {
                    var cell = new mxCell('F-WAIT', new mxGeometry(0, 0, 76, 30), 'shape=document;whiteSpace=wrap;html=1;boundedLbl=1;dropTarget=0;fontSize=11;',jaConstants.ICON_TYPE_FILE_WAIT,'F-WAIT',null, null);
                    cell.vertex = true;

                    var cell1 = new mxCell('W', new mxGeometry(0.9, 0.95, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_FILE_WAIT,jaConstants.CHILD_ICON,null, null);
                    cell1.vertex = true;
                    cell1.geometry.relative = true;
                    cell1.geometry.offset = new mxPoint(-7, -14);
                    cell.insert(cell1);

                    return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'F-WAIT',null,null,null,true);
                }),
        this.addEntry('general subprocess sub process sub-process', function()
                {
                    var cell = new mxCell('REBOOT', new mxGeometry(0, 0, 76, 30), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;fontSize=11;',jaConstants.ICON_TYPE_REBOOT,'REBOOT',null, null);
                    cell.vertex = true;

                    var cell1 = new mxCell('Ͽ', new mxGeometry(0.9, 0.95, 14, 14), 'html=1;outlineConnect=none;rotation=90;fontSize=15;',jaConstants.ICON_TYPE_REBOOT,jaConstants.CHILD_ICON,null, null);
                    cell1.vertex = true;
                    cell1.geometry.relative = true;
                    cell1.geometry.offset = new mxPoint(-7, -14);
                    cell.insert(cell1);

                    return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'REBOOT',null,null,null,true);
                }),
        this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;fontSize=11;', 76, 30, 'ZABBIX', null, null, null, '',true, jaConstants.ICON_TYPE_ZABBIX),
        this.addEntry('general subprocess sub process sub-process', function()
        {
            var cell = new mxCell('RELEASE', new mxGeometry(0, 0, 76, 30), 'shape=release;html=1;whiteSpace=wrap;rounded=0;dropTarget=0;fontSize=11;',jaConstants.ICON_TYPE_RELEASE,'RELEASE',null, null);
            cell.vertex = true;

            var cell1 = new mxCell('R', new mxGeometry(0.9, 0.98, 14, 14), 'ellipse;html=1;outlineConnect=none;',null,jaConstants.CHILD_ICON,null, null, jaConstants.ICON_TYPE_RELEASE);
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.geometry.offset = new mxPoint(-7, -14);
            cell.insert(cell1);

            return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'RELEASE',null,null,null,true);
        }),
        this.addEntry('general subprocess sub process sub-process', function()
        {
            var cell = new mxCell('AGENTLESS', new mxGeometry(0, 0, 76, 30), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;fontSize=11;',jaConstants.ICON_TYPE_AGENT_LESS,'AGENTLESS',null, null);
            cell.vertex = true;

            var cell1 = new mxCell('L', new mxGeometry(0.9, 0.98, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_AGENT_LESS,jaConstants.CHILD_ICON,null, null);
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.geometry.offset = new mxPoint(-7, -14);
            cell.insert(cell1);

            return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'AGENTLESS',null,null,null,true);
        }),

    ];

    if(this.editorUi.editor.graph.graphScreen != jaConstants.JOBNET_ICON_GRAPH){
        fns = [...fns, this.createVertexTemplateEntry('shape=jobnet;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fontSize=11;', 76, 30, 'JOBNET', null, null, null, '',true, jaConstants.ICON_TYPE_JOBNET)]
    }
...
Sidebar.prototype.addMiscPalette = function(expand)
{
    ...
    var fns = [
        ...
        this.createVertexTemplateEntry('shape=ext;double=0;rounded=1;whiteSpace=wrap;html=1;', 120, 80, '', 'My Oval', null, null, 'rect rectangle box double'),
 ...
 */
Sidebar.prototype.createItem = function(cells, title, showLabel, showTitle, width, height, allowCellsInserted,overrideWH = false)
{
    var elt = document.createElement('a');
    elt.className = 'geItem';
    if(cells.length > 0){
        if(cells[0].cellType == jaConstants.ICON_TYPE_JOBNET){
            elt.className = 'geItem geItemJobnetIcon';
        }
    }
    elt.style.overflow = 'hidden';
    var border = (mxClient.IS_QUIRKS) ? 8 + 2 * this.thumbPadding : 2 * this.thumbBorder;  
    if(overrideWH){
        elt.style.width = (width + border) + 'px';
        elt.style.height = (height + border) + 'px';
    } else {
    ...
    if(overrideWH){
        this.createThumb(cells, width, height, elt, title, showLabel, showTitle, width, height);
    } else {
    ...
    {
        //updated by dat at 09/12/2022 allowsplit value from true to false
    ...
    if (!mxClient.IS_IOS)
    {
        mxEvent.addGestureListeners(elt, null, mxUtils.bind(this, function(evt)
        {
            ...
            {
                this.showTooltip(null, cells, bounds.width, bounds.height, title, showLabel);
            }
        }));
    }
                ...
                if (!graph.isCellLocked(target || graph.getDefaultParent()))
                {
                    ...
                    try
                    {
                        ...
                        if(cells[i].edge == false){
                                ...
                                // }
                                if(cells[i].cellType == jaConstants.ICON_TYPE_JOBNET && isSelectedIfJobNetIcon == null){
                                    graph.jobnetIconDropHandler({cells, bounds, graph, target, x, y, evt});
                                    
                                    isSelectedIfJobNetIcon = "display";
                                }
                            }
                        };

                        if(isSelectedIfJobNetIcon == "display"){
                            return null;
                        }
                    ...
                    {
                        graph.model.endUpdate();
                        // $( "foreignObject div div div:contains('CAL-')" ).css( "transform", "rotate(-180deg)" ) ꓛꓶⱯꓛ;
                        // $('foreignObject div div div:contains("CALC")').css('transform', 'rotate(-180deg)');
                        // var tt = $('.geEditor foreignObject div div div:contains("CAL-")');
                        // $('.geEditor foreignObject div div div:contains("CAL-")').css('transform', 'rotate(180deg)');
                    }
...
createDropHandlerForJobnetIcon = function(cells, allowSplit, allowCellsInserted, bounds, graph, target, x, y, evt, jobnetId, jobnetName)
{
    var elt = null;
        ...
        if (cells.length > 0)
        {
            ...
            if (!graph.isCellLocked(target || graph.getDefaultParent()))
            {
                ...
                try
                {
                    ...
                    cells[0].jobId = jobnetId;
                    cells[0].jobName = jobnetName;
                    cells[0].iconSetting = {jobId : cells[0].jobId, jobName : cells[0].jobName, linkJobnetId : jobnetId};
                    let label = `<div style="height: 15px; width: 80px; overflow:hidden; white-space: nowrap; text-overflow: ellipsis;">${jobnetId}</div>`;
                    if(jobnetName){
                    label += `<div style="height:15px; width: 80px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">${jobnetName}</div>`;
                    }
                    cells[0].value = label;
                ...
                {
                    graph.model.endUpdate();
                    // $( "foreignObject div div div:contains('CAL-')" ).css( "transform", "rotate(-180deg)" );
                }
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,overrideWH = false, cellType = false)
{
    tags = (tags != null && tags.length > 0) ? tags : ((title != null) ? title.toLowerCase() : '');

    return this.addEntry(tags, mxUtils.bind(this, function()
    {
        return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle,null,overrideWH, cellType);
    }));
}
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted,overrideWH = false, cellType = false)
{
    var cells = [new mxCell((value != null) ? value : '', new mxGeometry(0, 0, width, height), style, cellType, value, null, null)];
    cells[0].vertex = true;

    return this.createVertexTemplateFromCells(cells, width, height, title, showLabel, showTitle, allowCellsInserted,overrideWH);
};

/**
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateFromData = function(data, width, height, title, showLabel, showTitle, allowCellsInserted,overrideWH = false)
{
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateFromCells = function(cells, width, height, title, showLabel, showTitle, allowCellsInserted,overrideWH = false)
{
    ...
    return this.createItem(cells, title, showLabel, showTitle, width, height, allowCellsInserted,overrideWH);
};

/**
 *
 */
Sidebar.prototype.createEdgeTemplateEntry = function(style, width, height, value, title, showLabel, tags, allowCellsInserted,overrideWH = false)
{
    tags = (tags != null && tags.length > 0) ? tags : title.toLowerCase();

    return this.addEntry(tags, mxUtils.bind(this, function()
    {
        return this.createEdgeTemplate(style, width, height, value, title, showLabel, allowCellsInserted,overrideWH);
    }));
};
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createEdgeTemplate = function(style, width, height, value, title, showLabel, allowCellsInserted,overrideWH=false)
{
    ...
    return this.createEdgeTemplateFromCells([cell], width, height, title, showLabel, allowCellsInserted,overrideWH);
};

/**
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createEdgeTemplateFromCells = function(cells, width, height, title, showLabel, allowCellsInserted,overrideWH=false)
{
    return this.createItem(cells, title, showLabel, true, width, height, allowCellsInserted,false);
};
