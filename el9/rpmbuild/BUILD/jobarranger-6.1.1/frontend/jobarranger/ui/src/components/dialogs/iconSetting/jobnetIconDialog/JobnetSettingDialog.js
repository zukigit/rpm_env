...
import "./JobnetSettingDialog.scss";
import {
  getExecIconSettingNextZIndex,
  removeExecOpenDialog,
} from "../../../../store/JobExecutionSlice";
import { INVALID_STRING, REGEX_PATTERM, SERVICE_RESPONSE } from "../../../../constants";
import {
  isImpossibleStr,
...
const JobnetSettingDialog = ({
  ...
  useEffect(() => {
    ...
    JobnetService.getJobnetInfo({
      jobnetId: cell.iconSetting.linkJobnetId,
    })
      .then((result) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Row className="mt-10x">
              <Col span={6}>{t("label-jobnet-id")}</Col>
              <Col span={18}>{cell.iconSetting.linkJobnetId}</Col>
            </Row>
            <Row className="mt-10x">
...
export default JobnetSettingDialog;
