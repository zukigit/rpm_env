	...
	try
	{
		if (navigator != null && navigator.language != null)
		{
			...
			mxGraph.prototype.pageFormat = (lang === 'en-us' || lang === 'en-ca' || lang === 'es-mx') ?
				mxConstants.PAGE_FORMAT_CUSTOM : mxConstants.PAGE_FORMAT_A4_PORTRAIT;
		}
	}
	catch (e)
	{
...
//check start icon already exist on graph
Graph.prototype.isStartIconExist = false;

Graph.prototype.jobnetPopupGraph = null;

//JOB TYPE LIST
Graph.prototype.jobTypeList = {
	4 : {
		cellType : jaConstants.ICON_TYPE_JOB,
		dValue : 'JOB',
	...
	5 : {
		cellType : jaConstants.ICON_TYPE_JOBNET,
		dValue : 'JOBNET',
		style : 'shape=jobnet;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fontSize=11;',
		width : 76,
		height : 30,
	},
	2 : {
		cellType : jaConstants.ICON_TYPE_CONDITIONAL_START,
		dValue : 'IF',
		style : 'rhombus;whiteSpace=wrap;html=1;fontSize=11;',
		width : 76,
		height : 30
	},
	13 : {
		cellType : jaConstants.ICON_TYPE_CONDITIONAL_END,
		dValue : '|',
		style : 'rhombus;whiteSpace=wrap;html=1;fontSize=11;',
		width : 35,
		height : 35
	...
	6 : {
		cellType : jaConstants.ICON_TYPE_PARALLEL_START,
		dValue : 'E',
		style : 'rounded=0;whiteSpace=wrap;html=1;rotation=90;fontSize=20;',
		width : 35,
		height : 35
	},
	7 : {
		cellType : jaConstants.ICON_TYPE_PARALLEL_END,
		dValue : 'E',
		style : 'rounded=0;whiteSpace=wrap;html=1;rotation=270;fontSize=20;',
		width : 35,
		height : 35
	},
	3 : {
		cellType : jaConstants.ICON_TYPE_JOB_CONTROL_VARIABLE,
		dValue : 'VARIABLE',
		style : 'shape=parallelogram;html=1;fontSize=11;',
		width : 76,
		height : 30
	},
	9 : {
		cellType : jaConstants.ICON_TYPE_EXTENDED_JOB, 
		dValue : 'EXTENSION',
		style : 'shshape=process;whiteSpace=wrap;html=1;backgroundOutline=1;fontSize=11;',
		width : 76,
		height : 30
	},
	0 : {
		cellType : jaConstants.ICON_TYPE_START,
		dValue : 'START',
		style : 'rounded=1;whiteSpace=wrap;html=1;fontSize=11;arcSize=50;',
		width : 76,
		height : 30
	},
	1 : {
		cellType : jaConstants.ICON_TYPE_END,
		dValue : 'END',
		style : 'rounded=1;whiteSpace=wrap;html=1;fontSize=11;arcSize=50;',
		width : 76,
		height : 30
	...
	10 : {
		cellType : jaConstants.ICON_TYPE_CALCULATION,
		dValue : 'ꓛꓶⱯꓛ',
		style : 'shape=trapezoid;html=1;fontSize=11;',
		width : 76,
		height : 30
	},
	8 : {
		cellType : jaConstants.ICON_TYPE_LOOP,
		dValue : 'L',
		style : 'rounded=0;whiteSpace=wrap;html=1;fontSize=20;fontSize=20;',
		width : 35,
		height : 35
	},
	11 : {
		cellType : jaConstants.ICON_TYPE_TASK,
		dValue : 'TASK',
		style : 'shape=hexagon;whiteSpace=wrap;html=1;fontSize=11;',
		width : 76,
		height : 30
	},
	12 : {
		cellType : jaConstants.ICON_TYPE_INFO,
		dValue : 'INFO',
		style : 'shape=card;whiteSpace=wrap;html=1;fontSize=11;',
		width : 76,
		height : 30
	},
	14 : {
		cellType : jaConstants.ICON_TYPE_FILE_COPY,
		dValue : 'F-TRANSFER',
		style : 'shape=document;whiteSpace=wrap;html=1;boundedLbl=1;dropTarget=0;fontSize=11;',
		width : 76,
		height : 30,
		childCell : function(){
			var cell1 = new mxCell('&#8680;', new mxGeometry(0.9, 0.95, 14, 14), 'boundary=none;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_FILE_COPY,'F-TRANSFER',null, null);
			cell1.vertex = true;
	...
	15 : {
		cellType : jaConstants.ICON_TYPE_FILE_WAIT,
		dValue : 'F-WAIT',
		style : 'shape=document;whiteSpace=wrap;html=1;boundedLbl=1;dropTarget=0;fontSize=11;',
		width : 76,
		height : 30,
		childCell : function(){
			var cell1 = new mxCell('W', new mxGeometry(0.9, 0.95, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_FILE_WAIT,'F-WAIT',null, null);
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxPoint(-7, -14);
			return cell1;
	...
	16 : {
		cellType : jaConstants.ICON_TYPE_REBOOT,
		dValue : 'REBOOT',
		style : 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;fontSize=11;',
		width : 76,
		height : 30,
		childCell : function(){
			var cell1 = new mxCell('Ͽ', new mxGeometry(0.9, 0.95, 14, 14), 'html=1;outlineConnect=none;rotation=90;fontSize=15;',jaConstants.ICON_TYPE_REBOOT,'REBOOT',null, null);
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxPoint(-7, -14);
			return cell1;
	...
	17 : {
		cellType : jaConstants.ICON_TYPE_RELEASE,
		dValue : 'RELEASE',
		style : 'shape=release;html=1;whiteSpace=wrap;rounded=0;dropTarget=0;fontSize=11;',
		width : 76,
		height : 30,
		childCell : function(){
			var cell1 = new mxCell('R', new mxGeometry(0.9, 0.98, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_RELEASE,'RELEASE',null, null);
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.geometry.offset = new mxPoint(-7, -14);
			return cell1;
	...
	18 : {
		cellType : jaConstants.ICON_TYPE_AGENT_LESS,
		dValue : 'AGENTLESS',
		style : 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;fontSize=11;',
		width : 76,
		height : 30,
		childCell : function(){
			var cell1 = new mxCell('L', new mxGeometry(0.9, 0.98, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_AGENT_LESS,'AGENTLESS',null, null);
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.geometry.offset = new mxPoint(-7, -14);
			return cell1;
	...
	19 : {
		cellType : jaConstants.ICON_TYPE_ZABBIX,
		dValue : 'ZABBIX',
...
//Child Cell Generate
Graph.prototype.childCellGen = function(cellType)
{
	var cell1 = null;
	if(cellType == jaConstants.ICON_TYPE_FILE_COPY){
		cell1 = new mxCell('&#8680;', new mxGeometry(0.9, 0.95, 14, 14), 'boundary=none;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_FILE_COPY,jaConstants.CHILD_ICON,null, null);
		cell1.vertex = true;
		cell1.geometry.relative = true;
		cell1.geometry.offset = new mxPoint(-7, -14);
	}else if(cellType == jaConstants.ICON_TYPE_FILE_WAIT){
		cell1 = new mxCell('W', new mxGeometry(0.9, 0.95, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_FILE_WAIT,jaConstants.CHILD_ICON,null, null);
		cell1.vertex = true;
		cell1.geometry.relative = true;
		cell1.geometry.offset = new mxPoint(-7, -14);
	}else if(cellType == jaConstants.ICON_TYPE_REBOOT){
		cell1 = new mxCell('Ͽ', new mxGeometry(0.9, 0.95, 14, 14), 'html=1;outlineConnect=none;rotation=90;fontSize=15;',jaConstants.ICON_TYPE_REBOOT,jaConstants.CHILD_ICON,null, null);
		cell1.vertex = true;
		cell1.geometry.relative = true;
		cell1.geometry.offset = new mxPoint(-7, -14);
	}else if(cellType == jaConstants.ICON_TYPE_RELEASE){
		cell1 = new mxCell('R', new mxGeometry(0.9, 0.98, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_RELEASE,jaConstants.CHILD_ICON,null, null);
		cell1.vertex = true;
		cell1.geometry.relative = true;
		cell1.geometry.offset = new mxPoint(-7, -14);
	}else if(cellType == jaConstants.ICON_TYPE_AGENT_LESS){
		cell1 = new mxCell('L', new mxGeometry(0.9, 0.98, 14, 14), 'ellipse;html=1;outlineConnect=none;',jaConstants.ICON_TYPE_AGENT_LESS,jaConstants.CHILD_ICON,null, null);
		cell1.vertex = true;
		cell1.geometry.relative = true;
		cell1.geometry.offset = new mxPoint(-7, -14);
}
 ...
 */
 HoverIcons.prototype.tolerance = (mxClient.IS_TOUCH) ? 1 : 0;
...
{
	if(state.cell.dValue != jaConstants.CHILD_ICON){
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		Graph.prototype.moveCells = function(cells, dx, dy, clone, target, evt, mapping)
		{
			...
			if(clone && cells.length > 0){
				for (var i = 0; i < cells.length; i++)
				{
					if(!cells[i].edge){
						cells[i].incomingEdge = {
							normalFlow : 0,
							trueFlow : 0,
							falseFlow : 0
						  }
						  cells[i].outgoingEdge = {
							normalFlow : 0,
							trueFlow : 0,
							falseFlow : 0
						  }
			...
			try
			{
				...
				for (var i = 0; i < cells.length; i++)
				{
					...
					if(cells[i].edge && clone){
						const sourceIndex = cells.findIndex((source) => {
							return source.id === cells[i].source.id;
						});

						if(sourceIndex != -1){
							cells[i].sourceId = cells[i].source.id;
							if(cells[i].edgeType == 2){
								cells[sourceIndex].outgoingEdge.falseFlow++
							}else if(cells[i].edgeType == 1){
								cells[sourceIndex].outgoingEdge.trueFlow++
							}else{
								cells[sourceIndex].outgoingEdge.normalFlow++
							}
						}

						const targetIndex = cells.findIndex((target) => {
							return target.id === cells[i].target.id;
						});

						if(targetIndex != -1){
							cells[i].targetId = cells[i].target.id;
							if(cells[i].edgeType == 2){
								cells[targetIndex].incomingEdge.falseFlow++
							}else if(cells[i].edgeType == 1){
								cells[targetIndex].incomingEdge.trueFlow++
							}else{
								cells[targetIndex].incomingEdge.normalFlow++
							}
						}
		...
		Graph.prototype.click = function(me)
		{
		 ...
		 Graph.prototype.getTranslateObject = function()
		 {
		 };

		 Graph.prototype.alertError = function(msg)
		 {
		 };

		 Graph.prototype.detectGraphChange = function(msg)
		 {
		 };

		 Graph.prototype.singleJobRun = function(jobId, iconSetting, methodFlag)
		 {
		 };

		 Graph.prototype.isFormDisable = function()
		 {
		 };

		 //Execute Job Right Click Menu Action 
		 Graph.prototype.setSkipJob = function(innerJobnetId, innerJobId, runStatus)
		 {
		 };

		 Graph.prototype.setHoldJob = function(innerJobnetId, innerJobId)
		 {
		 };

		 Graph.prototype.setNormalJob = function(innerJobnetId, innerJobId)
		 {
		 };

		 Graph.prototype.setRerun = function(innerJobnetId, innerJobId)
		 {
		 };

		 Graph.prototype.setForceStop = function(innerJobnetId, innerJobId)
		 {
		 };

		 Graph.prototype.variableValueChange = function(innerJobnetId, innerJobId, cells)
		 {
		 };

		 Graph.prototype.viewVariableValue = function(cells)
		 {
		 };
		 ...
		 */
		 Graph.prototype.jobnetIconDropHandler = function(dataObj)
		 {
		 };

		 Graph.prototype.createDropHandlerForJobnetIcon = function(cells, allowSplit, allowCellsInserted, bounds, graph, target, x, y, evt, jobnetId, jobnetName, publicFlag, updatedDate, tooltipLabel)
		 {
			 var elt = null;
				 ...
				 if (cells.length > 0)
				 {
					 ...
					 if (!graph.isCellLocked(target || graph.getDefaultParent()))
					 {
						 ...
						 try
						 {
							 ...
							 cells[0].iconSetting = {jobId : cells[0].jobId, jobName : cells[0].jobName, linkJobnetId : jobnetId, publicFlag, updatedDate};
		 
							 cells[0].value = cells[0].jobId;
							 graph.model.setTooltipLabel(cells[0], tooltipLabel);
		 ...
		 * Overrides double click handling to add the tolerance and inserting text.
		 */
		Graph.prototype.dblClick = function(evt, state)
		{
		};
		...
		Graph.prototype.deleteCells = function(cells, includeEdges)
		{
			...
			if (cells != null && cells.length > 0)
			{
				...
				if(cells[0].edge){
					if(cells[0].target != null){
						cells[0].target.setConnectable(true);
					}
					if(cells[0].source != null){
						cells[0].source.setConnectable(true);
					}
				}
