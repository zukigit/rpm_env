...
mxCellRenderer.prototype.redraw = function(state, force, rendering)
{
	...
	// if(state.cell.cellType == jaConstants.ICON_TYPE_PARALLEL_START || state.cell.cellType == jaConstants.ICON_TYPE_PARALLEL_END || state.cell.cellType == jaConstants.ICON_TYPE_LOOP){
    //     state.width = 30.5
    //     state.height = 30.5;
    // }
