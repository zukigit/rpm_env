 ...
 */
 var mxConstants =
 {
	...
	PAGE_FORMAT_LETTER_PORTRAIT: new mxRectangle(0, 0, 850, 1100),
		...
		/**
	 * Variable: PAGE_FORMAT_CUSTOM
	 * 
	 * Defines the rectangle for the CUSTOM page format. The
	 * dimensions of this page format are 3000x3000 pixels.
	 */
	PAGE_FORMAT_CUSTOM: new mxRectangle(0, 0, 10000, 10000),
