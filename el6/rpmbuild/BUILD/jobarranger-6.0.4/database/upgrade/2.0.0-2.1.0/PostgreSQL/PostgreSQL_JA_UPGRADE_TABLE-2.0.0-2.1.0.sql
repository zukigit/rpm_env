...
-- Job Arranger upgrade table SQL for PostgreSQL (Ver 2.0.0 -> 2.1.0)  - 2014/10/30 -
...
ALTER TABLE ja_schedule_detail_table   DROP CONSTRAINT ja_schedule_detail_pk;
...
ALTER TABLE ja_icon_end_table             ALTER COLUMN jobnet_stop_code  TYPE varchar(256);
...
ALTER TABLE ja_run_jobnet_summary_table     ADD COLUMN virtual_time           bigint           DEFAULT '0' NOT NULL;
ALTER TABLE ja_run_jobnet_summary_table     ADD COLUMN virtual_start_time     bigint           DEFAULT '0' NOT NULL;
ALTER TABLE ja_run_jobnet_summary_table     ADD COLUMN virtual_end_time       bigint           DEFAULT '0' NOT NULL;
ALTER TABLE ja_run_jobnet_summary_table     ADD COLUMN start_pending_flag     integer          DEFAULT '0' NOT NULL;
ALTER TABLE ja_run_jobnet_summary_table     ADD COLUMN initial_scheduled_time bigint           DEFAULT '0' NOT NULL;
...
ALTER TABLE ja_run_jobnet_table             ADD COLUMN virtual_time           bigint           DEFAULT '0' NOT NULL;
ALTER TABLE ja_run_jobnet_table             ADD COLUMN virtual_start_time     bigint           DEFAULT '0' NOT NULL;
ALTER TABLE ja_run_jobnet_table             ADD COLUMN virtual_end_time       bigint           DEFAULT '0' NOT NULL;
ALTER TABLE ja_run_jobnet_table             ADD COLUMN initial_scheduled_time bigint           DEFAULT '0' NOT NULL;
...
ALTER TABLE ja_run_icon_end_table         ALTER COLUMN jobnet_stop_code  TYPE varchar(256);
...
INSERT INTO ja_parameter_table (parameter_name, value) VALUES ('ZBXSND_RETRY_COUNT',    '0');
